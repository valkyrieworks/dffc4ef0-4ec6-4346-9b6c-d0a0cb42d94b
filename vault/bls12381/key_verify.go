...
func TestNewPrivateKeyFromBytes(t *testing.T) {
	...
	_, err = bls12381.NewPrivateKeyFromBytes(vault.CRandBytes(31))
	assert.Error(t, err)
}
...
func TestPubKey_NewPublicKeyFromInvalidBytes(t *testing.T) {
	...
	testCases := []struct {
		...
		{"REDACTED", "REDACTED", bls12381.ErrInfinitePubKey},
		{"REDACTED", "REDACTED", bls12381.ErrDeserialization},
		{"REDACTED", "REDACTED", bls12381.ErrDeserialization},
	}
