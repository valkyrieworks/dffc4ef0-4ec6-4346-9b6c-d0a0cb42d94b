...
//
//
func (privKey PrivKey) PubKey() vault.PubKey {
	return PubKey{pk: new(blstPublicKey).From(privKey.sk)}
}

//
func (privKey PrivKey) Equals(other vault.PrivKey) bool {
...
//
//
func (pubKey PubKey) Address() vault.Address {
	return vault.Address(comethash.SumTruncated(pubKey.pk.Serialize()))
}
...
//
func (pubKey PubKey) Equals(other vault.PubKey) bool {
