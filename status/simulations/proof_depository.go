...
//
type ProofDepository struct {
	mock.Emulate
}

//
func (_m *ProofDepository) AppendProof(_a0 kinds.Proof) error {
	ret := _m.Called(_a0)
...
//
func (_m *ProofDepository) InspectProof(_a0 kinds.ProofCatalog) error {
	ret := _m.Called(_a0)
...
//
func (_m *ProofDepository) AwaitingProof(maximumOctets int64) ([]kinds.Proof, int64) {
...
//
func (_m *ProofDepository) Modify(_a0 status.Status, _a1 kinds.ProofCatalog) {
	_m.Called(_a0, _a1)
}

//
//
func NewProofDepository(t interface {
	mock.TestingT
	Sanitize(func())
}) *ProofDepository {
	emulate := &ProofDepository{}
	mock.Emulate.Test(t)
